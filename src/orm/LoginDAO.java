...
public class LoginDAO {
	...
	public static boolean save(orm.Login login) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().saveObject(login);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Login login) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().deleteObject(login);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Login login)throws PersistentException {
		try {
			...
			orm.Consumo[] lConsumos = login.consumo.toArray();
			...
			orm.Historico_cliente[] lHistorico_clientes = login.historico_cliente.toArray();
			for(int i = 0; i < lHistorico_clientes.length; i++) {
				lHistorico_clientes[i].setLogin(null);
			}
			return delete(login);
		}
		catch(Exception e) {
	...
	public static boolean refresh(orm.Login login) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().refresh(login);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Login login) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().evict(login);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
