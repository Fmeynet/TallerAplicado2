...
public class ClienteDAO {
	...
	public static boolean save(orm.Cliente cliente) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().saveObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Cliente cliente) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().deleteObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Cliente cliente)throws PersistentException {
		try {
			...
			orm.Historico_cliente[] lHistorico_clientes = cliente.historico_cliente.toArray();
			for(int i = 0; i < lHistorico_clientes.length; i++) {
				lHistorico_clientes[i].setCliente(null);
			}
	...
	public static boolean refresh(orm.Cliente cliente) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().refresh(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Cliente cliente) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().evict(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
