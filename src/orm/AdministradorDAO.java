...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Administrador) session.load(orm.Administrador.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Administrador) session.get(orm.Administrador.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(orm.Administrador.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(orm.Administrador.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From orm.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new orm.Administrador();
	}
	
	public static boolean save(orm.Administrador administrador) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Administrador administrador) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Administrador administrador)throws PersistentException {
		try {
			orm.Login[] lLogins = administrador.login.toArray();
			for(int i = 0; i < lLogins.length; i++) {
				lLogins[i].setAdministrador(null);
			}
	...
	public static boolean deleteAndDissociate(orm.Administrador administrador, org.orm.PersistentSession session)throws PersistentException {
		try {
			orm.Login[] lLogins = administrador.login.toArray();
			for(int i = 0; i < lLogins.length; i++) {
				lLogins[i].setAdministrador(null);
	...
	public static boolean refresh(orm.Administrador administrador) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Administrador administrador) throws PersistentException {
		try {
			orm.TallerAp1PersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
