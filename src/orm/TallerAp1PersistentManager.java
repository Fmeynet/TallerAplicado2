...
public class TallerAp1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TallerAp1";
	...
	private TallerAp1PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TallerAp1PersistentManager();
		}
